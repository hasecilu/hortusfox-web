...
return [
	...
	'reset_password_hint' => 'Por favor, accede al enlace para reiniciar tu contraseña de acceso a {workspace}: <a href="{url}">Reiniciar contraseña</a>',
	'dashboard' => 'Panel',
	...
	'value' => 'Valor',
	'location' => 'Ubicación',
	'last_watered' => 'Regada por última vez',
	'last_repotted' => 'Replantada por última vez',
	'last_fertilised' => 'Abonada por última vez',
	'perennial' => 'Perenne',
	'annual' => 'Anual',
	...
	'overwatered' => 'Regada en exceso',
	'withering' => 'Marchitamiento',
	'infected' => 'Infectado',
	'pest_infestation' => 'Infestación de plagas',
	'transplant_shock' => 'Choque de trasplante',
	...
	'input_search' => 'Introduce el texto a buscar',
	...
	'set_watered' => 'Marcar como regado',
	...
	'group' => 'Grupo',
	'confirmInventoryítemRemoval' => '¿Seguro que quieres borrar este ítem?',
	'add_inventory_item' => 'Añadir ítem al inventario',
	'edit_inventory_item' => 'Editar ítem del inventario',
	...
	'account_created_hint' => 'Tu cuenta para {workspace} acaba de ser creada. Por favor <a href="{url}">inicia sesión</a> con tu e-mail y la contraseña <strong>{password}</strong>. Se recomienda encarecidamente cambiar la contraseña tras iniciar sesión por primera vez.',
	...
	'sorting_type_last_fertilised' => 'Abonado/a por última vez',
	...
	'notify_tasks_overdue' => 'Notificarme sobre tareas atrasadas',
	...
	'notify_tasks_tomorrow' => 'Notificarme sobre tareas con fecha límite de mañana',
	...
	'new_version_available' => 'La versión {new_version} está disponible. Consíguela <a href="{url}">aquí</a>.',
	'no_new_version_available' => 'Estás usando la última versión.',
	'admin_media' => 'Medios',
	'media_logo' => 'Logo del espacio de trabajo (imagen .png)',
	...
	'php_version' => 'Versión de PHP: {version}',
	'mysql_version' => 'Versión de MySQL: {version}',
	'server_system_info' => 'Servidor: {osn} {osv} en {mt}',
	...
	'set_repotted' => 'Marcar como trasplantado',
	'bulk_set_repotted' => 'Marcar plantas como trasplantadas',
	...
	'themes_hint' => 'Aquí puedes importar temas. Selecciona un archivo Zip del tema elegido para importarlo y una vez se haya realizado, el tema estará disponible para todos los usuarios. Nota: Si el archivo Zip contiene múltiples temas, el sistema intentará importarlos todos.',
	...
	'error_room_not_empty' => 'La ubicación no está vacía. Debes crear otra ubicación a la que migrar las plantas o eliminar todas las plantas antes de eliminar la ubicación.',
	...
	'noListItemsSelected' => 'Ningún ítem seleccionado',
	'set_fertilised' => 'Marcar como fertilizado',
	'bulk_set_fertilised' => 'Marcar plantas como fertilizadas',
	...
	'weather_cache' => 'Duración de caché (segundos)',
	'monday' => 'Lunes',
	'tuesday' => 'Martes',
	'wednesday' => 'Miércoles',
	'thursday' => 'Jueves',
	...
	'attributes_visibility_hint' => 'Aquí puedes elegir qué atributos de planta predeterminados estarán disponibles.',
	'confirm_remove_task' => '¿Realmente quieres eliminar esta tarea?',
	'plant_photo_orientation_hint' => 'Utiliza orientación vertical para la foto principal.',
	'select' => 'Seleccionar',
	...
	'attribute_schema_removed_successfully' => 'El atributo global de la planta se eliminó exitosamente',
	...
	'donation_kofi' => 'Cómprame un café',
	...
	'share_photo_public' => 'Compartir esta foto públicamente',
	'share_photo_description' => 'Descripción',
	'share_photo_keywords' => 'Palabras clave',
	'auth' => 'Autentificar',
	'auth_proxy_enable' => 'Habilitar autenticación de proxy',
	'auth_proxy_header_email' => 'Encabezado HTTP para correo electrónico',
	'auth_proxy_header_username' => 'Encabezado HTTP para nombre de usuario',
	'auth_proxy_sign_up' => 'Registrar automaticamente usuarios desconocidos',
	'auth_proxy_whitelist' => 'Lista permisiva de direcciones del proxy',
	'auth_proxy_hide_logout' => 'Ocultar botón de cierre de sesión',
	'proxy_auth_settings_saved_successfully' => 'Los ajustes de autenticación del proxy fueron guardados exitosamente',
	'auth_proxy_warning' => 'Advertencia: Asegúrate que la instancia de tu espacio de trabajo está protegida detrás de un proxy antes de habilitar esta característica',
	'auth_proxy_no_https_detected' => 'Precaución: No se detectó HTTPS. Por favor asegúrate que la comunicación en tu espacio de trabajo está protegida',
	'location_log' => 'Registro de ubicación',
	'location_log_content' => 'Contenido',
	'location_log_date' => 'Creado / Actualizado',
	'location_log_actions' => 'Acciones',
	'add_location_log_entry' => 'Añadir entrada',
	'edit_location_log_entry' => 'Editar entrada',
	'confirm_remove_location_log_entry' => '¿Realmente deseas eliminar esta entrada?',
	'no_location_log_entries_yet' => 'Sin entradas.',
	'share_api_host' => 'Host para compartir imágenes',
	'search_custom' => 'Buscar en atributos personalizados',
	'custom_bulk_commands' => 'Comandos en lote personalizados',
	'add_bulk_cmd' => 'Añadir comando en lote',
	'styles' => 'Estilos',
	'confirm_remove_bulk_cmd' => '¿Realmente desea eliminar este ítem?',
	'bulk_cmd_added_successfully' => 'El comando en lote fue añadido exitosamente',
	'bulk_cmd_updated_successfully' => 'El comando en lote fue editado exitosamente',
	'bulk_cmd_removed_successfully' => 'El comando en lote fue eliminado exitosamente',
	'plantrec_enable_label' => 'Habilitar el reconocimiento de plantas a través de Pl@ntNet',
	'plantrec_apikey_label' => 'Clave API de Pl@ntNet',
	'save_all' => 'Guardar todo',
	'date_select_today' => 'Utilizar la fecha de hoy',
